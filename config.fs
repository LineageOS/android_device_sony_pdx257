...
[product/app/DcmAccountWipeService_somc/DcmAccountWipeService_somc.apk]
mode: 0644
user: AID_SYSTEM
group: AID_SYSTEM
caps: 0

[product/app/DcmAccountWipeService_test_somc/DcmAccountWipeService_test_somc.apk]
mode: 0644
user: AID_SYSTEM
group: AID_SYSTEM
caps: 0

[product/app/rspermntt_somc/rspermntt_somc.apk]
mode: 0644
user: AID_SYSTEM
group: AID_SYSTEM
caps: 0
